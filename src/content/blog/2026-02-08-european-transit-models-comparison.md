...
```mermaid
flowchart LR
    subgraph before["Before €365 Pass (2012)"]
        P1["363,000 annual pass holders"]
        C1["Cars dominant"]
    end
    subgraph after["After €365 Pass (2024)"]
        P2["1.29 million annual pass holders"]
        C2["1.29M passes vs 736K registered cars"]
        M2["34% transit modal share"]
    end
