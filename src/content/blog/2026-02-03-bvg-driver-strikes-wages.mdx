---
title: 'Why BVG Drivers Walked Out: Wages, Strikes, and the 9.8:1 Ratio'
description: 'Berlin pays its transit drivers less than any other major German city while its CEO earns more relative to workers than any other state-owned enterprise. The 2025 Ver.di strikes were the result.'
pubDate: 'Feb 03 2026'
tags: ["berlin", "transit", "bvg", "labor"]
...
<BarChart
	client:visible
	title="BVG Annual Compensation: The 9.8:1 Ratio"
	horizontal={true}
	data={[
		{ label: "CEO (Falk)", value: 454000, color: "#c44dbb" },
		{ label: "Driver (entry)", value: 37000, color: "#2da87e" },
	]}
	format="euroK"
	valueLabel="Annual EUR"
/>
...
<BarChart
	client:visible
	title="Monthly Entry Wages: Berlin vs Munich vs Hamburg"
	horizontal={false}
	data={[
		{ label: "Berlin", value: 2807, color: "#e07c39" },
		{ label: "Munich", value: 3435, color: "#2da87e" },
		{ label: "Hamburg", value: 3277, color: "#5b8def" },
	]}
	format="euro"
	references={[{ label: "Berlin: \u20AC2,807", value: 2807 }]}
	valueLabel="EUR/month"
/>
...
```mermaid
flowchart TB
    N1["Negotiations begin<br/>Ver.di demands higher wages,<br/>35-hour week, 30 vacation days"]
    N1 --> W1["Warning Strike 1"]
    W1 --> N2["Negotiations resume, no agreement"]
    N2 --> W2["Warning Strike 2"]
    W2 --> W3["Warning Strike 3"]
    W3 --> N3["Negotiations stall"]
    N3 --> W4["Warning Strike 4"]
    W4 --> W5["Warning Strike 5"]
    W5 --> S["Schlichtung (Arbitration)<br/>Mediators: Platzeck + Ramelow"]
    S --> R["Settlement reached"]
...
<LineChart
	client:visible
	title="Berlin Driver Wage Trajectory vs Peer Cities"
	series={[
		{
			label: "Berlin (BVG)",
			data: [
	...
	references={[
		{ label: "Hamburg: \u20AC3,277", value: 3277, color: "#5b8def" },
		{ label: "Munich: \u20AC3,435", value: 3435, color: "#2da87e" },
	]}
	yLabel="EUR/month"
	formatYKey="euro"
/>
